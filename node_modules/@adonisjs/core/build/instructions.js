...
const ENV_VALIDATIONS_TEMPLATE_STUB = path_1.join(__dirname, './templates', 'env.txt');
const STATIC_TEMPLATE_STUB = path_1.join(__dirname, './templates', 'config', 'static.txt');
const APP_CONFIG_TEMPLATE_STUB = path_1.join(__dirname, './templates', 'config', 'app.txt');
/**
 * Configure package
 */
async function instructions(projectRoot, _, { logger, files }) {
    ...
    env.set('APP_KEY', utils_1.randomString(32));
    env.commit();
