...
class FileDriver {
    ...
    async read(sessionId) {
         ...
         */
        const verifiedContents = new utils_1.MessageBuilder().verify(contents.trim(), sessionId);
    ...
    async write(sessionId, values) {
        ...
        const message = new utils_1.MessageBuilder().build(values, undefined, sessionId);
