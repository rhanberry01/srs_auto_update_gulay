...
class MakeController extends Base_1.BaseGenerator {
    constructor() {
         ...
         */
        this.formIgnoreList = ['Home', 'Auth', 'Login', 'Authentication', 'Adonis', 'Dashboard'];
    }
    /**
...
__decorate([
    standalone_1.flags.boolean({ description: 'Adds resourceful methods to the controller class', alias: 'r' }),
