...
class Repl {
    ...
    printContextHelp() {
        ...
        const context = Object.keys((_a = this.server) === null || _a === void 0 ? void 0 : _a.context).reduce((result, key) => {
            var _a;
            if (!this.customMethods[key] && !GLOBAL_NODE_PROPERTIES.includes(key)) {
                result[key] = (_a = this.server) === null || _a === void 0 ? void 0 : _a.context[key];
            }
            return result;
        }, {});
    ...
    addMethod(name, handler, options) {
        const width = string_width_1.default((options === null || options === void 0 ? void 0 : options.usage) || name);
