...
class BaseCommand {
    ...
    constructor(application, kernel) {
         ...
         * Reference to cli ui
         */
        this.ui = api_1.instantiate(this.application.environment === 'test');
        /**
    ...
    static boot() {
        ...
        this.booted = true;
        utils_1.defineStaticProperty(this, BaseCommand, {
            propertyName: 'args',
            defaultValue: [],
            strategy: 'inherit',
        });
    ...
    async exec() {
        ...
        try {
            ...
            if (typeof this.prepare === 'function') {
                await this.application.container.call(this, 'prepare', []);
            }
            /**
             * Execute the command handle or run method
             */
            commandResult = await this.application.container.call(this, hasRun ? 'run' : 'handle', []);
        }
        catch (error) {
            this.error = error;
        }
        ...
        if (typeof this.completed === 'function') {
            errorHandled = await this.application.container.call(this, 'completed', []);
        }
        /**
