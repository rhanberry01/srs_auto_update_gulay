...
Serve.description = 'Start the AdonisJS HTTP server. Optionally watch for file changes';
Serve.settings = {
    stayAlive: true,
};
__decorate([
    standalone_1.flags.boolean({ description: 'Watch for file changes and re-start the HTTP server', alias: 'w' }),
