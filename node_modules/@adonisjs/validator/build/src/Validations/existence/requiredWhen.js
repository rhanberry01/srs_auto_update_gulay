...
exports.requiredWhen = {
    compile: helpers_1.wrapCompile(RULE_NAME, [], ([field, operator, comparisonValues]) => {
        /**
         ...
         * Value is a ref
         */
        if (helpers_1.isRef(comparisonValues)) {
            return {
    ...
    validate(value, compiledOptions, { errorReporter, pointer, arrayExpressionPointer, root, tip, refs }) {
         ...
         */
        const shouldBeRequired = OPERATORS[compiledOptions.operator].passes(helpers_1.getFieldValue(compiledOptions.field, root, tip), comparisonValues);
        /**
         * Validation
         */
        if (shouldBeRequired && !helpers_1.exists(value)) {
